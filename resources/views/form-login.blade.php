    ...
    <div id="wrapper" class="flex flex-col justify-between h-screen">
        ...
        <div>
            <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
                ...
                <div class="bg-gradient-to-br from-pink-500 border border-red-400 text-white to-red-400 w-full px-4 py-3 rounded relative" role="alert">   
                       {{ session('success') }}
                ...
                <div class="bg-red-500 border border-red-400 text-white w-full px-4 py-3 rounded relative" role="alert">   
                       {{ session('loginError') }}
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                      <svg class="fill-current h-6 w-6 text-white" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Close</title><path d="M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.819l-2.651 3.029a1.2 1.2 0 1 1-1.697-1.697l2.758-3.15-2.759-3.152a1.2 1.2 0 1 1 1.697-1.697L10 8.183l2.651-3.031a1.2 1.2 0 1 1 1.697 1.697l-2.758 3.152 2.758 3.15a1.2 1.2 0 0 1 0 1.698z"/></svg>
                    </span>
                ...
                <form action="/form-login" method="POST">
                    @csrf
                    <input type="email" id="email" name="email" autofocus required placeholder="example@mydomain.com" class="bg-gray-200 mb-2 shadow-none dark:bg-gray-800" style="border: 1px solid #d3d5d8 !important; @error('email') is-invalid
                        
                    @enderror" value="{{ old('email') }}">
                    @error('email')
                    <div class="flex items-center bg-blue text-red-500 text-sm font-bold px-4" style="margin-bottom: 5px" role="alert">
                    ...
                    @enderror
                    <input type="password" name="password" id="password" required placeholder="***********" class="bg-gray-200 mb-2 shadow-none dark:bg-gray-800" style="border: 1px solid #d3d5d8 !important;">
